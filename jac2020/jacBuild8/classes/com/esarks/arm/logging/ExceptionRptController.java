...
*/
    ...
    openOutput(path(getProperty("logPath") + ".") + lJobSlot + "_" + lReserved + "_" + lNow + ".xml");
//ScriptWriter~~%>
{
//ScriptWriter~~~
...
//ScriptWriter~~~
    ...
    iScript.execMethod("com.esarks.arm.logging.ExceptionRpt", "render", new Object[]{getProperty("logPath") + "." + lJobSlot + "_" + lReserved + "_" + lNow, lServiceJeo});
