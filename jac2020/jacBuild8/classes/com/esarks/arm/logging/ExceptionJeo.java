 ...
 */
    public ExceptionJeo() {
      iInstanceName = "com.esarks.arm.logging.ExceptionJeo";
...
//$Section=Operation$getXml$Preserve=no
    ...
    StringBuffer lXml = new StringBuffer("<jeo name='com.esarks.arm.logging.ExceptionJeo'>");
    String lCdataBegin = "<" + "!" + "[CDATA[";
// Field: Time
    lXml.append("<field name='Time' type='datetime'>");
    lXml.append(getTimePropertyValue().toString()).append("</field>");
// Field: Module
    lXml.append("<field name='Module' type='string'>");
    lXml.append(lCdataBegin).append(getModulePropertyValue().toString()).append("]]>").append("</field>");
// Field: Method
...
// Field: Severity
    lXml.append("<field name='Severity' type='string'>");
    lXml.append(lCdataBegin).append(getSeverityPropertyValue().toString()).append("]]>").append("</field>");
// Field: Location
...
// Field: Action
    lXml.append("<field name='Action' type='string'>");
    lXml.append(lCdataBegin).append(getActionPropertyValue().toString()).append("]]>").append("</field>");
// Field: Resolution
...
//$Section=Operation$isJeoEqual$Preserve=no
    ...
    lThisValue = this.getPropertyValueByName("time");
    lThatValue = aJeo.getPropertyValueByName("time");
    if (lThisValue.getValueType() != lThatValue.getValueType()) return false;
    if (lThisValue.compareTo(lThatValue) != 0) return false;
    lThisValue = this.getPropertyValueByName("module");
    lThatValue = aJeo.getPropertyValueByName("module");
    if (lThisValue.getValueType() != lThatValue.getValueType()) return false;
    if (lThisValue.compareTo(lThatValue) != 0) return false;
    ...
    if (lThisValue.getValueType() != lThatValue.getValueType()) return false;
    if (lThisValue.compareTo(lThatValue) != 0) return false;
    lThisValue = this.getPropertyValueByName("action");
    lThatValue = aJeo.getPropertyValueByName("action");
    if (lThisValue.getValueType() != lThatValue.getValueType()) return false;
    if (lThisValue.compareTo(lThatValue) != 0) return false;
