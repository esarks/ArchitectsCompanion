...
//  Generated at 2005.11.10 12:41:58.062 PM EST by Architect's Companion (c) 2003, Architects of Software Design, Corp., ALL RIGHTS RESERVED
 ...
 */
    public RequestJeo() {
      super("com.esarks.arm.model.jeo.RequestJeo");
 ...
 */
    public RequestJeo( com.esarks.jac.JeoFactory aJeoFactory ) {
      super(aJeoFactory);
      init("com.esarks.arm.model.jeo.RequestJeo");
 ...
 */
    public RequestJeo( Script aScript ) {
      super("com.esarks.arm.model.jeo.RequestJeo", aScript);
 ...
 */
    public RequestJeo( String aTypeName ) {
      super("com.esarks.arm.model.jeo.RequestJeo", aTypeName);
 ...
 */
    public RequestJeo( String aTypeName, Script aScript ) {
      super("com.esarks.arm.model.jeo.RequestJeo", aTypeName, aScript);
...
//$Section=Operation$getCasedName$Preserve=no
    ...
    try {
        Method lMethod = this.getClass().getMethod("getAttributeName_" + aAttributeName.toLowerCase(), (Class<?>[]) null);
        return (String) lMethod.invoke(this, (Object[]) null);
    } catch (Throwable e) {
...
//$Section=Operation$getPropertyValueByName$Preserve=no
    ...
    try {
        Method lMethod = this.getClass().getMethod("get" + getCasedName(aAttributeName) + "PropertyValue", (Class<?>[]) null);
        return (PropertyValue) lMethod.invoke(this, (Object[]) null);
    } catch (Throwable e) {
        //System.out.println(e);
        return null;
    }
...
//$Section=Operation$getTypeByName$Preserve=no
    ...
    try {
        Method lMethod = this.getClass().getMethod("get" + getCasedName(aAttributeName) + "ValueType", (Class<?>[]) null);
        return (String) lMethod.invoke(this, (Object[]) null);
    } catch (Throwable e) {
        //System.out.println(e);
        return null;
...
//$Section=Operation$getStereotypeByName$Preserve=no
    ...
    try {
        Method lMethod = this.getClass().getMethod("get" + getCasedName(aAttributeName) + "ValueStereotype", (Class<?>[]) null);
        return (String) lMethod.invoke(this, (Object[]) null);
    } catch (Throwable e) {
        //System.out.println(e);
        return null;
