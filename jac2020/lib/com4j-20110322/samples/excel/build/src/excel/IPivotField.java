...
public interface IPivotField extends Com4jObject {
   ...
   * </p>
   * @return  Returns a value of type excel.XlPivotFieldCalculation
   */

  @VTID(10)
  excel.XlPivotFieldCalculation getCalculation();
   ...
   * </p>
   * @param rhs Mandatory excel.XlPivotFieldCalculation parameter.
   */

  @VTID(11)
  void setCalculation(
    excel.XlPivotFieldCalculation rhs);
  ...
  @VTID(12)
  excel.PivotField getChildField();
   ...
   * </p>
   * @return  Returns a value of type excel.XlPivotFieldDataType
   */

  @VTID(17)
  excel.XlPivotFieldDataType getDataType();
  ...
  @VTID(20)
  excel.XlConsolidationFunction getFunction();
   ...
   * </p>
   * @param rhs Mandatory excel.XlConsolidationFunction parameter.
   */

  @VTID(21)
  void setFunction(
    excel.XlConsolidationFunction rhs);
  ...
  @VTID(33)
  excel.PivotField getParentField();
  ...
  /**
   * @return  Returns a value of type excel.CalculatedItems
   */
  ...
  @VTID(99)
  excel.PivotField getPropertyParentField();
  ...
  @VTID(125)
  excel.PivotFilters getPivotFilters();
  ...
  @VTID(126)
  excel.PivotLine getAutoSortPivotLine();
