...
public interface TextRange2 extends office._IMsoDispObj,Iterable<Com4jObject> {
  ...
  @VTID(15)
  office.TextRange2 getParagraphs(
  ...
  @VTID(16)
  office.TextRange2 getSentences(
    @Optional @DefaultValue("-1") int start,
    @Optional @DefaultValue("-1") int length);
  ...
  @VTID(18)
  office.TextRange2 getCharacters(
    @Optional @DefaultValue("-1") int start,
    @Optional @DefaultValue("-1") int length);
  ...
  @VTID(21)
  office.ParagraphFormat2 getParagraphFormat();
  ...
  @VTID(45)
  office.MsoLanguageID getLanguageID();
