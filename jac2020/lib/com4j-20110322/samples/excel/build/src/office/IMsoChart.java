...
public interface IMsoChart extends Com4jObject {
  ...
  @VTID(10)
  office.IMsoChartTitle getChartTitle();
  ...
  @DISPID(1610743826) //= 0x60020012. The runtime will prefer the VTID if present
  @VTID(26)
  office.XlDisplayBlanksAs getDisplayBlanksAs();
  ...
  @VTID(65)
  office.IMsoPlotArea getPlotArea();
  ...
  @VTID(68)
  office.IMsoChartArea getChartArea();
  ...
  @VTID(75)
  office.IMsoDataTable getDataTable();
  ...
  @VTID(100)
  office.IMsoChartData getChartData();
  ...
  @VTID(105)
  office.IMsoChartGroup getArea3DGroup(
    @LCID int lcid);
  ...
  @VTID(107)
  office.IMsoChartGroup getBar3DGroup(
    @LCID int lcid);
  ...
  @VTID(109)
  office.IMsoChartGroup getColumn3DGroup(
    @LCID int lcid);
  ...
  @VTID(111)
  office.IMsoChartGroup getLine3DGroup(
    @LCID int lcid);
  ...
  @VTID(113)
  office.IMsoChartGroup getPie3DGroup(
    @LCID int lcid);
  ...
  @VTID(117)
  office.IMsoChartGroup getSurfaceGroup(
    @LCID int lcid);
