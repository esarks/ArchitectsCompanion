...
public interface _CommandBarComboBox extends office.CommandBarControl {
  // Methods:
  /**
   ...
   * </p>
   * @return  Returns a value of type office.MsoComboStyle
   */

  @DISPID(1610940430) //= 0x6005000e. The runtime will prefer the VTID if present
  @VTID(97)
  office.MsoComboStyle getStyle();
   ...
   * </p>
   * @param pstyle Mandatory office.MsoComboStyle parameter.
   */

  @DISPID(1610940430) //= 0x6005000e. The runtime will prefer the VTID if present
  @VTID(98)
  void setStyle(
    office.MsoComboStyle pstyle);
