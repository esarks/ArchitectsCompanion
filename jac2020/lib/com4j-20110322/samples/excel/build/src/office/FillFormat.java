...
public interface FillFormat extends office._IMsoDispObj {
  ...
  @VTID(19)
  office.ColorFormat getBackColor();
  ...
  @VTID(21)
  office.ColorFormat getForeColor();
  ...
  @VTID(37)
  office.GradientStops getGradientStops();


  @VTID(37)
  @ReturnValue(defaultPropertyThrough={office.GradientStops.class})
  office.GradientStop getGradientStops(
    int index);
  ...
  @VTID(42)
  office.MsoTextureAlignment getTextureAlignment();
  ...
  @VTID(48)
  office.MsoTriState getTextureTile();
  ...
  @VTID(50)
  office.MsoTriState getRotateWithObject();
