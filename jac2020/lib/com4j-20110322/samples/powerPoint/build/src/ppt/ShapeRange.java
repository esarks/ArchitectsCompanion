...
@IID("{9149347A-5A91-11CF-8700-00AA0060263B}")
public interface ShapeRange extends Com4jObject,Iterable<Com4jObject> {
  ...
  /**
   * @param maxPointsInBuffer Mandatory int parameter.
   * @param pPoints Mandatory Holder<Float> parameter.
   * @param numPointsInPolygon Mandatory Holder<Integer> parameter.
   * @param isOpen Mandatory Holder<office.MsoTriState> parameter.
   */

  @DISPID(2020) //= 0x7e4. The runtime will prefer the VTID if present
  @VTID(83)
  void getPolygonalRepresentation(
    int maxPointsInBuffer,
    Holder<Float> pPoints,
    Holder<Integer> numPointsInPolygon,
    Holder<office.MsoTriState> isOpen);
