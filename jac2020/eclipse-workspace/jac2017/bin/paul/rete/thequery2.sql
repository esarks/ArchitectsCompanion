...
LEFT JOIN reteAmView AS reteAmView_1 ON reteProductionJoinView.parentConditionId = reteAmView_1.reteCondition.id)
...
INNER JOIN reteAmView ON reteProductionJoinView.conditionId = reteAmView.reteCondition.id)
