...
//ScriptWriter~~~
iOutputManager.println("", false);
//ScriptWriter~~2. Home Phone Number = <![record:phone:number]!>
iOutputManager.println("2. Home Phone Number = " + iSymbolTable.translateProperties("[record:phone:number]") + "", true);
//ScriptWriter~~<%
iOutputManager.println("", false);
//ScriptWriter~~~
}
